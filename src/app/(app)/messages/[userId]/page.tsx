  ...
  return (
    <div className="flex flex-col h-[calc(100vh-10rem)]">
      <Link href={`/profile/${other?.username}`} className="flex items-center gap-2 mb-4 min-w-0">
        ...
        <UserIdentity displayName={other?.display_name || ''} verified={other?.verified} role={other?.role} customRoles={other?.custom_roles} nameEffect={other?.name_effect} pts={other?.points} />
      </Link>
