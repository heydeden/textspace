...
export const GET = withUser(async (req, user) => {
  ...
  const other = await sql`SELECT id, username, display_name, role, points, verified, custom_roles, name_effect, avatar_style, avatar_seed FROM profiles WHERE id = ${userId}`;
