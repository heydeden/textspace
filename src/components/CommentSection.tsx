...
interface Comment {
  ...
  user_id: string; username: string; display_name: string; role?: string; points?: number; verified?: boolean; custom_roles?: string[];
}
  ...
  return (
    <div className={`border-b border-zinc-800 py-2 last:border-0 ${indent ? 'ml-6 border-l border-zinc-800 pl-3' : ''}`}>
      <div className="flex items-center justify-between">
          <UserIdentity displayName={comment.display_name} verified={comment.verified} role={comment.role} customRoles={comment.custom_roles} pts={comment.points} />
