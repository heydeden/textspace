...
interface Comment {
  ...
  user_id: string; username: string; display_name: string; role?: string; verified?: boolean; badges?: { id: string; name: string; theme?: string; effect?: string }[]; name_effect?: { id: string; name?: string; theme?: string; effect?: string } | null;
}
  ...
  return (
    <div className={`border-b border-zinc-800 py-2 last:border-0 ${indent ? 'ml-6 border-l border-zinc-800 pl-3' : ''}`}>
      <div className="flex items-center justify-between">
          <UserIdentity displayName={comment.display_name} verified={comment.verified} role={comment.role} badges={comment.badges} nameEffect={comment.name_effect} />
